...
class ClientsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'client_status' => ['type' => 'string', 'length' => 30, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            'id' => 1,
            'client_status' => 'Lorem ipsum dolor sit amet',
            'user_id' => 1
        ],
    ];
}
